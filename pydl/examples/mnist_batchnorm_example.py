...
def main():
    ...
    nn = NN(X, layers)
    momentum = Momentum(nn, mu=0.5, step_size=1e-2, reg_lambda=1e-1, train_size=60000, test_size=10000)
    momentum.train(X, y, normalize='pca', dims=0.97, shuffle=False, epochs=10000, plot='Momentum',
                   log_freq=1)
