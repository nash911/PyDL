...
def main():
    ...
    adam = Adam(nn, step_size=1e-3, beta_1=0.9,  beta_2=0.999, reg_lambda=1e-1, train_size=60000,
                test_size=10000)
    adam.train(X, y, normalize='pca', dims=0.97, shuffle=False, epochs=10000, log_freq=1,
